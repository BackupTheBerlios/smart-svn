...
class ViewArticleEditArticle extends SmartView
{
    ...
    */
    ...
    private function initVars()
    {
        ...
        $this->current_id_node = $this->model->session->get('id_node');
        if(NULL === $this->current_id_node)
        {
        ...
        $this->current_id_article = $this->model->session->get('id_article');
        if(NULL === $this->current_id_article)
        {
