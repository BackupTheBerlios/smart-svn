    ...
    <td align="center" valign="top" bgcolor="#EBEBEB">      <table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="31%" align="left" valign="top"><table width="100%"  border="0" align="left" cellpadding="2" cellspacing="2">
            <tr>
              <td width="100%" height="50" align="left" valign="top" class="style6"><img src="./modules/common/media/smart_logo.gif" width="129" height="50" align="left">  Ver.: <?php echo $tpl['smartVersionNumber']; ?></td>
              </tr>
          </table></td>
...
<?php if($tpl['showHeaderFooter'] == TRUE): ?>    
  ...
  <tr>
      <td align="left" valign="top" bgcolor="#EBEBEB"><table width="100%"  border="0" cellspacing="2" cellpadding="2">
          <tr>
              <td><span class="font9 style8">&copy; 2006 Armand Turpel <a href="mailto:framework@smart3.org">framework@smart3.org</a>. Project site -&gt; <a href="http://www.smart3.org" target="_blank">SMART3</a>.</span></td>
          </tr>
    </table></td>
  </tr>
</table>
