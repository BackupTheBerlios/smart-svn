...
$expiresOffset = 3600 * 24;    // 1 day util client cache expires
$diskCache = true;            // If you enable this option gzip files will be cached on disk.
$cacheDir = realpath("../../../../data/common/tinymce_cache");        // Absolute directory path to where cached gz files will be stored
