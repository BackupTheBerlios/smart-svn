<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <?php echo '<a href="'.SF_CONTROLLER.'?admin=1&m=navigation&dir=up&node='.$node_id.'">up</a>'; ?>
    <?php echo '<a href="'.SF_CONTROLLER.'?admin=1&m=navigation&dir=down&node='.$node_id.'">down</a>'; ?>
    </font></td>
          <td width="90%" align="left" valign="top" class="itemnormal">
              <?php echo '<a href="'.SF_CONTROLLER.'?admin=1&m=navigation&sec=editnode&node='.$node_id.'">'.$node['title'].'</a>'; ?></td>
      </tr>
    </table>
    <?php endforeach; ?>
    </td>
