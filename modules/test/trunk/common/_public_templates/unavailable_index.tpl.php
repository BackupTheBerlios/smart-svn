...
<body>
<p>This site is currently unavailable. Please come back later.<br><br>This page is produced by the "unavailable_index.tpl.php" template.<br><br><a href="<?php echo SF_CONTROLLER; ?>?admin=1">back to admin</a></p>
</body>
</html>
