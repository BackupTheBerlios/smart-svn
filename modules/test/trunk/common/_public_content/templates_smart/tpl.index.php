        ...
        <td width="640" align="left" valign="top"><table width="640" border="0" cellspacing="4" cellpadding="2">
          <tr>
            <td align="left" valign="top">
              ...
              <p class="text">The base framework has no build in high level functionalities. It only manage modules. An application based on this framework become alive through modules. &quot;Little Jo&quot;, an example application give you an impression what this means. This site is build up on &quot;little Jo&quot;.</p>
              <p class="text">SMART has a build in templates support, which was never planned but, which inevitable rose from the internal logic of SMART. You can control the templates presentation behaviour through view classes, which retrives the needed data from different modules through event calls. The template language is <a href="http://www.php.net/" target="_blank">PHP</a>.</p>
