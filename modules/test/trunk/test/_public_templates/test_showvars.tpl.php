...
The following system array ($B->sys) contains vars which are always
accessible in any template. Example to access a single variable from this array:<br />
<strong>Charset = <?php echo $B->sys['option']['charset']; ?></strong></font></p>
<p>Here is the complete array structure:<br /><strong><pre><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><?php print_r($B->sys); ?></font></pre></strong>
</p>
</body>
</html>
