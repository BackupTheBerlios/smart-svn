...
class user_upgrade
{
    ...
    function perform( $data )
    {
        ...
        if(version_compare( '0.5', (string)$this->B->sys['module']['user']['version'], '>'))
        {
            $this->B->dbmanager->alterTable($this->B->sys['db']['table_prefix'].'user_seq_add_user_seq', array('name' => $this->B->sys['db']['table_prefix'].'user_users_seq'));
        }
