<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <table width="100%"  border="0" cellspacing="6" cellpadding="6">
      <tr>
        <td width="1%" align="left" valign="top"><?php echo '<a href="index.php?m=NAVIGATION&mf=edit_node&node_id='.$node->id.'">edit</a>'; ?></td>
    ...
    <td width="11%" align="center" valign="top" class="itemnormal"><a href="index.php?m=NAVIGATION&mf=add_node&parent_id=<?php echo $_REQUEST['id_node']; ?>">add node</a></td>
  </tr>
</table>
