	...
	<table width="100%"  border="0" cellspacing="4" cellpadding="4">
      ...
      <tr>
        ...
        <td width="97%" align="left" valign="top">
          ...
          <a href="index.php?m=EARCHIVE&mf=edit_mess&mid=<?php echo $msg['mid']; ?>&pageID=<?php echo $_GET['pageID']; ?>&lid=<?php echo $msg['lid']; ?>" class="font12bold"><?php echo $msg['subject']; ?></a>
        </td>
      </tr>
      <?php endforeach; ?>
      <?php else: ?>
