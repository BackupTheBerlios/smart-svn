    ...
    <td align="center" valign="middle" bgcolor="#3399CC">      <table width="100%"  border="0" cellspacing="2" cellpadding="2">
        <tr>
          <td width="39%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td align="left" valign="top"><span class="style6">ADMIN</span> &nbsp;&nbsp;<span class="style4">E-archive 0.2.4b</span></td>
            </tr>
          </table></td>
      ...
      <?php if($B->user_is_logged != FALSE): ?>
            <form action="<?php echo SF_CONTROLLER; ?>" method="post">
