    ...
    <?php endif; ?>
      ...
      <tr>
        ...
        <td width="97%" align="left" valign="top">
          ...
          <a href="index.php?admin=1&m=earchive&sec=editmessages&mid=<?php echo $msg['mid']; ?>&pageID=<?php echo $_GET['pageID']; ?>&lid=<?php echo $msg['lid']; ?>" class="font12bold"><?php echo $msg['subject']; ?></a>
        </td>
      </tr>
      <?php endforeach; ?>
      <?php else: ?>
