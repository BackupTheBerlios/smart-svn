...
{
    trigger_error( 'The module filter handler '.EARCHIVE_FILTER.' is already registered: '.__FILE__.' '.__LINE__, E_USER_ERROR  );        
}
...
function earchive_filter_handler( $evt )
{
    ...
    if(!is_object($GLOBALS[$class_name]))
    {
        ...
        $class_file = SF_BASE_DIR . 'modules/earchive/filters/class.'.$class_name.'.php';
