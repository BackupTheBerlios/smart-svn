...
/**
* 
* Provides an object-oriented interface to template functions.
*
* Savant2 helps you to separate model logic and view logic.  Please see the
* documentation at {@link http://phpsavant.com/}.
*
* By default, Savant2 does not compile templates.  However, you may pass
* an optional compiler object to compile template source to include-able
* PHP code.
*
* $Id: Savant2.php,v 1.6 2004/06/26 19:21:11 pmjones Exp $
* 
...
class Savant2 {
	...
	*/
	...
	/**
	* 
	* The set of search directories for reources (plugins/filters) and
	* templates.
	* 
	* @access private
	* 
	...
	* @access public
	*
	* @param string $type The type of rpath to set, typcially 'template'
	* or 'resource'.
	* 
	...
	*/
	...
	function assign()
	{
		...
		if (is_string($arg[0]) && $arg[0]{0} != '_' && isset($arg[1])) {
			$this->$arg[0] = $arg[1];
		} else {
	...
	*/
	...
	/**
	*
	* Loads a template script for execution.
	* 
	...
	*/
	...
	function fetch($tpl = null)
	{
		...
		foreach (get_object_vars($this) as $_prop => $_val) {
			if ($_prop{0} != '_') {
	...
	*/
	...
	function loadPlugin($name, $conf = array())
	{
	...
	*/
	...
	function loadFilter($name, $conf = array())
	{
	...
	* @access public
	*
	* @param string $text The text to wshich filters should be applied.  If null,
	* sets the text to $this->_output.
	*
	* @return string The text after being passed through all loded filters.
	* 
	*/
