 ...
 *
 * $Id: Reader.php,v 1.51 2004/06/04 19:46:15 schst Exp $
 *
...
class patTemplate_Reader extends patTemplate_Module
{
    ...
    */
    function _parseAttributes( $string )
    {
        ...
        {
            $attributes[strtolower( $match[1][$i] )] = (string)$match[2][$i];
        }
        return  $attributes;
    }
    ...
    function _endElement( $ns, $name )
    {
        ...
        switch( $name )
        {
            ...
            default:
                ...
                $result = $this->_functions[$name]->call( $el['attributes'], $data );
    ...
    function _prepareTmplAttributes( $attributes, $templatename )
    {
        ...
        switch( $attributes['type'] )
        {
            ...
            case    'simplecondition':
                ...
                $attributes['requiredvars'] = array_map( 'trim', explode( ',', strtoupper( $attributes['requiredvars'] ) ) );
                $attributes['autoclear']    = 'yes';
                break;
