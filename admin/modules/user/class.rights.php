...
{ 
    /**
     * check if the user id demanded is the same
     * as the login user
     *
    ...
    /**
     * check if the login user have rights to add users
     *
     * @return bool
     */
    ...
    /**
     * check if the login user have rights to set rights
     * of other users
     *
     * @param int $uid user id to modify
    ...
    /**
     * check if the login user have rights to set status
     * of other users
     *
     * @param int $uid user id to modify
     * @return bool
